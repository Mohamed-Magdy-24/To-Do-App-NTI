            ...
            listener: (context, state) {
              if (state is ChangePasswordFailing) {
                AppSnakBar.showSnakBar(
                  title: AppString.kError,
                  message: state.errMessage,
                );
              } else if (state is ChangePasswordSuccess) {
                AppSnakBar.showSnakBar2(
                  title: AppString.kSuccess,
                  message: AppString.kchangePasswordSuccess,
                );
                ...
                child: Column(
                  ...
                  children: [
                    DefaultTextFormFiled(
                      label: AppString.kOldPassword,
                      hint: AppString.kOldPassword,
                    ...
                    DefaultTextFormFiled(
                      label: AppString.kNewPassword,
                      hint: AppString.kNewPassword,
                      validator: ChangePasswordCubit.get(context)
                          .appValidator
                          .passwordValidator,
                      controller: ChangePasswordCubit.get(context)
